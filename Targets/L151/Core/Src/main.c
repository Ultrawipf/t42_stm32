...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED0_Pin|LED1_Pin|OUT1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(OUT0_GPIO_Port, OUT0_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED0_Pin LED1_Pin OUT1_Pin */
  GPIO_InitStruct.Pin = LED0_Pin|LED1_Pin|OUT1_Pin;
  ...
  /*Configure GPIO pins : PB8 BTN1_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_8|BTN1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
